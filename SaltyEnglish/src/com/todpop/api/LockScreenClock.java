...
public class LockScreenClock {
    ...
    {
        this(context, LockScreenClock.TICKPERMINUTE); 
    }
    public LockScreenClock(Context context,int tickMethod)
    {
    ...
    {
    	LockScreenClock.this.Time.set(LockScreenClock.this.Time.toMillis(true)+tickInMillis);
    ...
    private void StartTickPerMinute()
    {
        ...
        this.IntentFilter.addAction(Intent.ACTION_TIMEZONE_CHANGED);
        this.IntentFilter.addAction(Intent.ACTION_TIME_CHANGED);
