...
public class StudyTestMockFinish extends TypefaceActivity {
	// popup view
	...
	private MediaPlayer.OnCompletionListener cl = new MediaPlayer.OnCompletionListener() {
		...
		public void onCompletion(MediaPlayer mp) {
			...
			Intent intent = new Intent(getApplicationContext(),StudyTestMockResult.class);
			startActivity(intent);
			StudyTestMockFinish.this.finish();
		}
	};
